...
function ProtectedRoute({ children }) {
  ...
  const getUserData = useCallback(async () => {
    try {
      ...
      const response = await getUserInfo(); // Assuming this is a function to get user data
  ...
  }, [dispatch, getUserInfo, navigate]); // Add any dependencies used inside the function (like dispatch, getUserInfo, and navigate)
  ...
  }, [user, getUserData, navigate]); // Include getUserData as a stable dependency
